...
(function () {
  ...
  var lastTodoId = function lastTodoId() {
    return todos ? Math.max.apply(Math, _toConsumableArray(todos.map(function (_ref3) {
      var id = _ref3.id;
      return id;
    }))) + 1 : 1;
  };
  ...
  var addTodo = function addTodo() {
    ...
    var id = todos.length ? lastTodoId() : 1;
    var newTodo = { id: id, content: content, completed: false };

    _axios2.default.post('/todos', newTodo).then(function (res) {
      console.log('[ADD]\n', res.data);
      getTodos();
    }).catch(function (err) {
      return console.log(err.response);
  ...
  var toggleTodoAllComplete = function toggleTodoAllComplete(chkStatus) {
    _axios2.default.patch('/todos', { completed: chkStatus }).then(function () {
